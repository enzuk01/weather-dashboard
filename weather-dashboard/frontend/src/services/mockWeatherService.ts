...
export const fetchHourlyForecast = async (
    ...
    return {
        ...
        rain: precipitationArray.map(v => v * 0.8),
        showers: precipitationArray.map(v => v * 0.2),
        snowfall: precipitationArray.map(v => v * 0.1),
        cloud_cover: weatherCodeArray.map(code => (code - 1) * 50),
...
export const fetchDailyForecast = async (
    ...
    return {
        ...
        rain_sum: rainSum,
        showers_sum: precipitationSum.map(v => v * 0.2),
